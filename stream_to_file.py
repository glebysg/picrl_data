...
def save_frames(FILE_NAME):
    ...
    print("Saving colour and depth frames", FILE_NAME)
    
    # define file names
    depthfilename = "data\\DEPTH." + FILE_NAME +".pickle"
    colourfilename = "data\\COLOUR." + FILE_NAME +".pickle"
    bodyfilename = "data\\BODY." + FILE_NAME + ".txt"
    print(depthfilename)
    ...
    while True:
        ...
        if kinect.has_new_depth_frame() and kinect.has_new_color_frame() :
            ...
            if(elapsedtime> i/fps_projected):
